...
namespace game
{
	...
	public:
		...
		private:
			static const std::uintptr_t rva = 0x025A8A6C; // 0x02539100
		...
		private:
			static const std::uintptr_t rva = 0x02A3E9E4; // 0x029C7FD4
		...
		private:
			static const std::uintptr_t rva = 0x02A44285; // 0x029CD875
