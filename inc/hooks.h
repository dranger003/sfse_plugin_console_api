...
namespace game
{
	...
	public:
		...
		private:
			static const std::uintptr_t rva = 0x02539100; // 0x02539070
		...
		private:
			static const std::uintptr_t rva = 0x029C7FD4; // 0x029C7F44
		...
		private:
			static const std::uintptr_t rva = 0x029CD875; // 0x029CD7E5
