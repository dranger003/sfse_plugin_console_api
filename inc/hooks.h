...
namespace game
{
	...
	public:
		...
		private:
			static const std::uintptr_t rva = 0x025DF65C; // 0x025A8A6C
		...
		private:
			static const std::uintptr_t rva = 0x02AE23D4; // 0x02A3E9E4
		...
		private:
			static const std::uintptr_t rva = 0x02AE7C75; // 0x02A44285
