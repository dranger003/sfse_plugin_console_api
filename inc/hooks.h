...
namespace game
{
	...
	public:
		...
		private:
			static const std::uintptr_t rva = 0x023DC960; // 0x023DC6B0
		...
		private:
			static const std::uintptr_t rva = 0x02869764; // 0x028694B4
		...
		private:
			static const std::uintptr_t rva = 0x0286F005; // 0x0286ED55
