...
namespace game
{
	...
	public:
		...
		private:
			static const std::uintptr_t rva = 0x02538E10; // 0x02483910
		...
		private:
			static const std::uintptr_t rva = 0x029C7AC4; // 0x02911D84
		...
		private:
			static const std::uintptr_t rva = 0x029CD365; // 0x02917625
