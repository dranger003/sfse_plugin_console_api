...
namespace game
{
	...
	public:
		...
		private:
			static const std::uintptr_t rva = 0x02483910; // 0x023DC960
		...
		private:
			static const std::uintptr_t rva = 0x02911D84; // 0x02869764
		...
		private:
			static const std::uintptr_t rva = 0x02917625; // 0x0286F005
