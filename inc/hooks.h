...
namespace game
{
	...
	public:
		...
		private:
			static const std::uintptr_t rva = 0x02539070; // 0x02538E10
		...
		private:
			static const std::uintptr_t rva = 0x029C7F44; // 0x029C7AC4
		...
		private:
			static const std::uintptr_t rva = 0x029CD7E5; // 0x029CD365
